...
_Figure 2: catches in tonnes by area_
...
_Figure 3: catches in tonnes by area_
...
_Figure 4: Horse mackerel: relative catch at age by stock_
...
_Figure 5: Horse mackerel: relative catch at age by stock and area_
...
The relative catch in numbers by stock/area, age, year and cohort are shown in figure 5. The strong 2001 year class is most noticable in area 6 and 7 and for the younger ages in area 8. The 2001 year class is not very apparent in the western stock in 4a. For the North Sea stock, the cohort signal is a bit more vaguely apparent in area 7d and not in area 4. 
...
The catch in number by area and age from sampled catches is shown in figure 6. There appears to be a very limited sampling for horse mackerel in area 8a in the recent year even though there are sizeable catches in that area, predominantly believed to be younger ages. Also in area 7h there have been no sampling in 2016. An important sig-nal to be derived from these plots is that there appears to be increase in the catches of juveniles in the most recent years, mostly in area 7d and to a lesser extend also in area 7e. Measures to protect the incoming year classes of these species should be considered. 
